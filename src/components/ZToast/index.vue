...
const timer = ref<number | null | unknown>(null);
// const defineProps = {
...
function show(option = {}) {
  ...
  timer.value = <unknown>setTimeout(() => {
    visible.value = false;
  }, _option.duration);
}
...
<template>
  <div v-if="visible" class="toast-top toast-start top-12 toast">
